...
(function installSimpleEditEchoSettings() {
  ...
  function openModal() {
    ...
    const modal = ensureModal();
    window.orgavoxUpdateToolTarget?.(modal, clip, "Echo target");
