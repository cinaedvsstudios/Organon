(() => {
  ...
  const timingNote = document.querySelector('.effects-note');
  ...
  if (timingNote) timingNote.textContent = 'GIF normalises generated-frame timing to preserve the overall runtime.';
})();
