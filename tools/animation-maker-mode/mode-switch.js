(() => {
  ...
  if (modeButton) {
    ...
    modeButton.addEventListener('click', () => { location.href = isAdvanced ? './index.html' : './index.html?mode=advanced'; });
  }
  ...
  if (isAdvanced) {
    addScript('../animation-maker-mode/advanced-groups.js', () => addScript('../animation-maker-mode/advanced-groups-format.js'));
  } else {
