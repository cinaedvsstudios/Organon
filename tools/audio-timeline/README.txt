Organon Advanced Audio Timeline v0.18
...
Project File placement: drag a Project Files pill with the mouse/pointer directly onto any timeline lane. v0.18 uses pointer drag rather than browser-native HTML drag, so it does not depend on custom browser drag MIME support.
